...
const AddMenuForm = () => {
  ...
  return (
    <>
      <div className="items-center justify-center min-h-screen px-5 pb-5 lg:px-32 lg:flex">
        <div>
            ...
            <Grid container spacing={2}>
              <Grid className="flex flex-wrap gap-5" item xs={12}>
                ...
                <label className="relative" htmlFor="fileInput">
                  ...
                  {uploadImage && (
                    <div className="absolute top-0 bottom-0 left-0 right-0 flex items-center justify-center w-24 h-24">
                      <CircularProgress />
                    </div>
                  )}
                </label>
